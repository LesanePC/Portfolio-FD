...
const projectData = {
    ...
    'LiftForge - Fitness Tracker': {
        stack: 'React 19, TypeScript, Zustand, Tailwind CSS, Recharts, Vercel',
        contribution: [
        ...
        metrics: '14+ упражнений | Drag & Drop | Графики прогресса | Тепловая карта | Личные рекорды | Streak | Тёмная тема | Экспорт данных | PWA-ready'
    },
};
