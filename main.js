...
const projectData = {
    ...
    "Агентство недвижимости": {
        stack: "HTML, CSS, JavaScript (jQuery), Slick Slider",
        contribution: [
            "Разработал frontend для агентства недвижимости по ТЗ заказчика",
            "Реализовал динамическую фильтрацию объектов без перезагрузки страницы — ускорило поиск для посетителей",
            "Сделал галерею изображений в карточках объектов, адаптивный слайдер отзывов",
            "Интегрировал формы обратной связи, подготовленные для подключения к бэкенду"
        ],
        result: "По отзывам заказчика, удобный интерфейс увеличил количество заявок через сайт"
    },
    "Bakery — Сайт пекарни": {
